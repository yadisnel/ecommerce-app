...
final pickCategoryDialogStateKey = new GlobalKey<_PickCategoryDialogState>();


class PickCategoryDialog extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => _PickCategoryDialogState();
}

class _PickCategoryDialogState extends State<PickCategoryDialog> {
  /// this is useful for filtering purpose
  List<BaseModel> filteredElements;
  String filter = "";

  PickCategoryDialogBloc _pickCategoryDialogBloc;

  void refreshStreams(){
    _pickCategoryDialogBloc.refreshStreams();
  }

  @override
  Widget build(BuildContext context) {
    return StreamBuilder(
        stream: _pickCategoryDialogBloc.listCategoriesStream,
        initialData: null,
  ...
  @override
  void initState(){
    _pickCategoryDialogBloc = BlocProvider.of<PickCategoryDialogBloc>(context);
    super.initState();
  }
